...
class Meeting:
    ...
    def __init__(self, person1, person2, site, timestamp):
        ...
        self._people_involved: List[Person] = [person1, person2]
        self._location: Site = site
    ...
    def is_meeting_infected(self):
        ...
        :return boolean
        """
        return self._people_involved[1].traits.is_infected or \
               self._people_involved[0].traits.is_infected
